...
using PaymentMethod = SmartPhone_Shop.ViewModels.Utilities.Enums.PaymentMethod;
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(CheckoutViewModel request)
        {
            ...
            if (result != "Failed")
            {
                ...
                email1.Send("carong904@gmail.com", $"{x.Email}",
                ...
                email2.Send("carong904@gmail.com", userMail,
                                "ĐẶT HÀNG THÀNH CÔNG",
                                templateHtml
                                + orderSummaryHtml
                                );
        ...
        public async Task<IActionResult> Processing(string stripeToken, string stripeEmail, CheckoutViewModel request)
        {
            ...
            var optionsCharge = new ChargeCreateOptions
            {
                ...
                Amount = price,
                Currency = "VND",
                Description = "Đặt điện thoại tại SmartPhone Shop",
                Source = stripeToken,
                Shipping = shipping,
            ...
            if (result != "Failed")
            {
                // mail admin when have new email
                var email1 = new EmailService.EmailService();
                email1.Send("carong904@gmail.com", "carong904@gmail.com",
                    "ĐƠN HÀNG MỚI", $"Mã đơn hàng là <strong>{result}</strong>, nhấn vào <a href='" + "https://localhost:5002/Order/Detail?orderId=" + result + "'>đây</a> để đến trang quản lý đơn hàng này.");
