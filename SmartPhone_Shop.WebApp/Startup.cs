...
using SmartPhone_Shop.WebApp.Data;
using SmartPhone_Shop.WebApp.LocalizationResources;
using Stripe;
using System;
...
namespace SmartPhone_Shop.WebApp
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            StripeConfiguration.ApiKey = "sk_test_51NJUSFDN5decrxf8AopibH2GxaEmUhHMjHfjEwWHDHbqhUDOn25CyQKsS5KcTIXVHU9d3KGErlcqrFNzsUhCa4fg00Z7GlkIJH";
