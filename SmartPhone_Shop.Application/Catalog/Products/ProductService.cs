...
using SmartPhone_Shop.Utilities.Exceptions;
...
namespace SmartPhone_Shop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        {
            var check = await _context.Products.SingleOrDefaultAsync(x => x.Name.ToUpper().Equals(request.Name.ToUpper()));
            if (check != null)
            {
                throw new EShopException("Sản Phẩm đã tồn tại");
            }
